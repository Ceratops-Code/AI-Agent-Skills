...
| `skills/ceratops-gh-repo-lifecycle/scripts/github_pr_workflow/` | Package CLI for individual PR operations, caller-adapted dependency campaigns, and exact-commit checkpointed shipping with concurrent gates, reusable-branch restoration, and terminal same-PR checkpoint cleanup. |
