...
| `skills/ceratops-governance-lifecycle/scripts/apply_rules_update.py` | Rechecks one exact validated champion without fixing it, applies approved rule text unchanged with coupled history rollback, and cleans only explicitly disposable artifacts after success. |
