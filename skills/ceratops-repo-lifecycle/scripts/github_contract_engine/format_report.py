...
def write_json(payload: dict[str, Any], *, compact: bool = False) -> None:
    ...
    # The recursive sanitizer is the security boundary. The adjacent regression
    # test verifies both output modes before this single stdout sink.
