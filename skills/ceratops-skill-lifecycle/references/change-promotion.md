...
- (D) Pending-release state management and terminal cleanup:
...
- (D) Run `promote-skill-branches-to-release-and-install.ps1` with only
  ...
  are promoted and before profile-aware full validation and runtime
...
- Retain clean approved task worktrees and branches through remote review;
  ...
  cleanup.
- If the pending-release manager reports dirty or unmerged approved work, stop
  before installation.
